...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Registrando SRV-01: " + gestor.registrarActivo(srv1));
        System.out.println("Registrando SRV-02: " + gestor.registrarActivo(srv2));
        System.out.println("Registrando FW-01: " + gestor.registrarActivo(fw1));
        ...
        System.out.println("Aplicando parche a código inexistente (ERROR-404): " + gestor.aplicarParcheActivo("ERROR-404"));

        System.out.println("\n--- PRUEBA DE LÍMITE DE CAPACIDAD (MAX 10) ---");
